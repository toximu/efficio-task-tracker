...
namespace {
struct qt_meta_tag_ZN11ProjectListE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11ProjectListE = QtMocHelpers::stringData(
    "ProjectList"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ProjectListE[] = {
...
Q_CONSTINIT const QMetaObject ProjectList::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ProjectListE.offsetsAndSizes,
    qt_meta_data_ZN11ProjectListE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ProjectListE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProjectList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ProjectListE.stringdata0))
