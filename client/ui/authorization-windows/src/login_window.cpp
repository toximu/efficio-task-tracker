...
void LoginWindow::on_push_enter_clicked() {
    if ((this->counter_on_switch_theme_clicks++) % 2) {
        ...
        //     if (lang == "RU") {
        //         QMessageBox::warning(this, "Ошибка ввода данных",
        //         "Пожалуйста, заполните все поля!");
        //     } else {
        //         QMessageBox::warning(this, "Input Error", "Please fill in all
        //         the fields!");
        //     }
        //     return;
        // }
        ...
        // if (login.size() > 50) {
        //     if (lang == "RU") {
        //         QMessageBox::warning(this, "Ошибка", "Длина логина не должна
        //         превышать пятидесяти символов");
        //     } else {
        //         QMessageBox::warning(this, "Error", "Login must not exceed
        //         fifty characters");
        //     }
        //     return;
        // }
        ...
        // if (password.size() > 50) {
        //     if (lang == "RU") {
        //         QMessageBox::warning(this, "Ошибка", "Длина пароля не должна
        //         превышать пятидесяти символов");
        //     } else {
        //         QMessageBox::warning(this, "Error", "Password must not exceed
        //         fifty characters");
        //     }
        //     return;
        // }
        ...
        //     if (lang == "RU") {
        //         QMessageBox::warning(this, "Ошибка ввода данных", "Неверный
        //         логин или пароль!");
        //     } else {
        //         QMessageBox::warning(this, "Login Error", "Incorrect login or
        //         password!");
        //     }
        //     return;
        // }
