...
const std::list<Project> &User::get_projects() const { return projects_; }

Project & User::add_project(const Project &project) { projects_.push_back(project); return projects_.back(); }
